  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="grid gap-8">
        {/* Overview Card */}
        <Card className="border-2 border-blue-100 dark:border-blue-900/50 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border-2 border-green-200 dark:border-green-900/50 bg-green-50 dark:bg-green-900/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-4 h-4 rounded-full bg-green-500 dark:bg-green-400"></div>
                  <Badge variant="secondary" className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200">90-100</Badge>
                  <Badge variant="secondary" className="bg-green-200 dark:bg-green-800/50 text-green-900 dark:text-green-100 font-bold">A+ to A-</Badge>
                </div>
                <h4 className="font-semibold text-green-800 dark:text-green-200">Excellent</h4>
                <p className="text-sm text-green-700 dark:text-green-300">Outstanding financial health with strong savings and low expenses.</p>
              </div>

              <div className="p-4 rounded-lg border-2 border-blue-200 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-900/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-4 h-4 rounded-full bg-blue-500 dark:bg-blue-400"></div>
                  <Badge variant="secondary" className="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200">80-89</Badge>
                  <Badge variant="secondary" className="bg-blue-200 dark:bg-blue-800/50 text-blue-900 dark:text-blue-100 font-bold">B+ to B-</Badge>
                </div>
                <h4 className="font-semibold text-blue-800 dark:text-blue-200">Good</h4>
                <p className="text-sm text-blue-700 dark:text-blue-300">Solid financial foundation with room for minor improvements.</p>
              </div>

              <div className="p-4 rounded-lg border-2 border-yellow-200 dark:border-yellow-900/50 bg-yellow-50 dark:bg-yellow-900/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-4 h-4 rounded-full bg-yellow-500 dark:bg-yellow-400"></div>
                  <Badge variant="secondary" className="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200">65-79</Badge>
                  <Badge variant="secondary" className="bg-yellow-200 dark:bg-yellow-800/50 text-yellow-900 dark:text-yellow-100 font-bold">C+ to D+</Badge>
                </div>
                <h4 className="font-semibold text-yellow-800 dark:text-yellow-200">Fair</h4>
                <p className="text-sm text-yellow-700 dark:text-yellow-300">Decent financial health but with clear areas for improvement.</p>
              </div>

              <div className="p-4 rounded-lg border-2 border-orange-200 dark:border-orange-900/50 bg-orange-50 dark:bg-orange-900/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-4 h-4 rounded-full bg-orange-500 dark:bg-orange-400"></div>
                  <Badge variant="secondary" className="bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-200">30-64</Badge>
                  <Badge variant="secondary" className="bg-orange-200 dark:bg-orange-800/50 text-orange-900 dark:text-orange-100 font-bold">D to F</Badge>
                </div>
                <h4 className="font-semibold text-orange-800 dark:text-orange-200">Needs Improvement</h4>
                <p className="text-sm text-orange-700 dark:text-orange-300">Financial stability at risk, requires attention and action.</p>
              </div>

              <div className="p-4 rounded-lg border-2 border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-900/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-4 h-4 rounded-full bg-red-500 dark:bg-red-400"></div>
                  <Badge variant="secondary" className="bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200">0-29</Badge>
                  <Badge variant="secondary" className="bg-red-200 dark:bg-red-800/50 text-red-900 dark:text-red-100 font-bold">F</Badge>
                </div>
                <h4 className="font-semibold text-red-800 dark:text-red-200">Poor</h4>
                <p className="text-sm text-red-700 dark:text-red-300">Critical financial situation requiring immediate attention.</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="h-fit">
            ...
            <CardContent className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                ...
                <code className="text-sm bg-white dark:bg-gray-900 p-2 rounded border dark:border-gray-700 block">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center p-2 bg-green-50 dark:bg-green-900/20 rounded">
                    ...
                    <Badge variant="secondary" className="bg-green-100 dark:bg-green-800/50 text-green-800 dark:text-green-200">30 points</Badge>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-blue-50 dark:bg-blue-900/20 rounded">
                    <span>51-70% expenses</span>
                    <Badge variant="secondary" className="bg-blue-100 dark:bg-blue-800/50 text-blue-800 dark:text-blue-200">20 points</Badge>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-yellow-50 dark:bg-yellow-900/20 rounded">
                    <span>71-90% expenses</span>
                    <Badge variant="secondary" className="bg-yellow-100 dark:bg-yellow-800/50 text-yellow-800 dark:text-yellow-200">10 points</Badge>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-red-50 dark:bg-red-900/20 rounded">
                    <span>≥90% expenses</span>
                    <Badge variant="secondary" className="bg-red-100 dark:bg-red-800/50 text-red-800 dark:text-red-200">0 points</Badge>
                  </div>
                </div>
              </div>
          ...
          <Card className="h-fit">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <Badge className="bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200">30 Points Max</Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
          ...
          <Card className="h-fit">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <Badge className="bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-200">10 Points Max</Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center p-2 bg-green-50 dark:bg-green-900/20 rounded">
                    ...
                    <Badge variant="secondary" className="bg-green-100 dark:bg-green-800/50 text-green-800 dark:text-green-200">10 points</Badge>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-yellow-50 dark:bg-yellow-900/20 rounded">
                    <span>31-50% discretionary</span>
                    <Badge variant="secondary" className="bg-yellow-100 dark:bg-yellow-800/50 text-yellow-800 dark:text-yellow-200">5 points</Badge>
                  </div>
                  <div className="flex justify-between items-center p-2 bg-red-50 dark:bg-red-900/20 rounded">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg border border-orange-200 dark:border-orange-800/50">
        ...
        {/* Improvement Tips */}
        <Card className="border-2 border-emerald-200 dark:border-emerald-900/50 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20">
          <CardHeader>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-blue-800 dark:text-blue-200">Long-term Strategies:</h4>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
